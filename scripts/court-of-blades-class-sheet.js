 ...
 * @extends {ItemSheet}
 */
export class CourtOfBladesClassSheet extends ItemSheet {

  /** @override */
	static get defaultOptions() {
	  return foundry.utils.mergeObject(super.defaultOptions, {
  	  classes: ["court-of-blades", "sheet", "item", "class"],
  	  template: "modules/court-of-blades/templates/class-sheet.html",
      width: 600,
      height: 600
